---
name: ortus-java-coding-standards
description: "Use when writing, reviewing, or formatting any Ortus Solutions code (BoxLang, CFML, or Java) to ensure it follows the official Ortus coding standards: indentation, spacing, brace placement, naming, alignment, comments, and structural conventions."
license: MIT
metadata:
  author: https://github.com/Ortus-Solutions
  version: "1.0.0"
  domain: quality
  triggers: ortus standards, java formatting, eclipse formatter, coding conventions, style guide, indentation, tabs, code style, boxlang formatting, cfml formatting
  role: expert
  scope: review
  output-format: document
  related-skills: java-expert, code-reviewer
---
